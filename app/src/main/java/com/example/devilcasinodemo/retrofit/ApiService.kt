...
interface ApiService {
    ...
    suspend fun addCard(
        @Path("userId") userId: Long,
        @Body request: com.example.devilcasinodemo.mvc.dto.CreditCardRequest
    ): Response<com.example.devilcasinodemo.mvc.dto.CreditCardResponse>

    @GET("api/cards/{userId}")
    suspend fun getCards(
        @Path("userId") userId: Long
    ): Response<List<com.example.devilcasinodemo.mvc.dto.CreditCardResponse>>
